...
<h1>College Categories</h1>

<div class="col-sm-6">
    {!! Form::open(['method' => 'post', 'action' => 'AdminCollegeCategoriesController@store']) !!}
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        {!! Form::open(['method' => 'DELETE', 'action' => ['AdminCollegeCategoriesController@destroy', $category->id]]) !!}
